"""
Django settings for weathered_moon_47999 project.
...
ROOT_URLCONF = 'weathered_moon_47999.urls'
...
WSGI_APPLICATION = 'weathered_moon_47999.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_moon_47999 API",
    "DESCRIPTION": "API documentation for weathered_moon_47999 App",
    "VERSION": "v1",
}
